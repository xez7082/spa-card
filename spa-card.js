Voici le code complet corrigé. J'ai nettoyé en profondeur et supprimé toutes les traces résiduelles de cette section, y compris le bloc HTML qui gérait l'affichage textuel du statut ("En veille", "En chauffe", etc.), les calculs de temps restant, l'affichage de l'icône de connexion WiFi, ainsi que les variables associées dans `_renderHome()`.
