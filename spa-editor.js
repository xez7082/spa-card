...
export class SpaCardEditor extends LitElement {
  ...
  _acc(id, icon, title, schema) {
    // Protection : si hass n'est pas encore prêt, on n'affiche pas le formulaire
  ...
  render() {
    ...
    return html`
      <div class="editor-wrap">
        ...
        <div class="sections">
          ${this._tab === 'gen' 
            ? this._acc('a-disp', 'GEN', 'Apparence', [{name:'card_title', label:'Titre', selector:{text:{}}}]) 
  ...
  static styles = [
    ...
    css` 
      ...
      .tabs button { padding:10px; border:none; background:none; cursor:pointer; color: var(--secondary-text-color); } 
